// src/pieces.ts
// Standard chess piece SVGs - based on Wikipedia/Lichess style

export const PIECE_SVGS: Record<string, string> = {
  // WHITE KING
  'K-white': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
  ...
  // BLACK KING
  'K-black': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
    <g fill="none" fill-rule="evenodd" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
  ...
  // WHITE QUEEN
  'Q-white': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
  ...
  // BLACK QUEEN
  'Q-black': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
    <g fill-rule="evenodd" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
      ...
      <path d="M11.5 30c3.5-1 18.5-1 22 0m-21 3.5c6-1 15-1 21 0" fill="none" stroke="#fff"/>
    </g>
  </svg>`,

  // WHITE ROOK
  'R-white': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
    <g fill-rule="evenodd" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
      <path d="M9 39h27v-3H9v3zM12 36v-4h21v4H12zM11 14V9h4v2h5V9h5v2h5V9h4v5" stroke-linecap="butt" fill="#fff"/>
      <path d="M34 14l-3 3H14l-3-3" fill="#fff"/>
      <path d="M31 17v12.5H14V17" fill="#fff" stroke-linecap="butt" stroke-linejoin="miter"/>
      <path d="M31 29.5l1.5 2.5h-20l1.5-2.5" fill="#fff"/>
      <path d="M11 14h23" fill="none" stroke-linejoin="miter"/>
    </g>
  </svg>`,

  // BLACK ROOK
  'R-black': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
    <g fill-rule="evenodd" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
  ...
  // WHITE BISHOP
  'B-white': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
    <g fill="none" fill-rule="evenodd" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
  ...
  // BLACK BISHOP
  'B-black': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
    <g fill="none" fill-rule="evenodd" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
      ...
      <path d="M17.5 26h10m-12.5 4h15m-7.5-14.5v5M20 18h5" stroke="#fff" stroke-linejoin="miter"/>
    </g>
  </svg>`,

  // WHITE KNIGHT
  'N-white': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
    <g fill="none" fill-rule="evenodd" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
  ...
  // BLACK KNIGHT
  'N-black': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
    <g fill="none" fill-rule="evenodd" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
  ...
  // WHITE PAWN
  'P-white': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
  ...
  // BLACK PAWN
  'P-black': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
...
export function getPieceImage(pieceType: string, color: 'white' | 'black'): HTMLImageElement | null {
  ...
  if (!svg) {
    console.warn(`[Pieces] No SVG for ${key}`);
    return null;
  }
...
export function preloadPieces(): Promise<void> {
  ...
  const promises = pieces.flatMap(piece => 
    colors.map(color => new Promise<void>((resolve) => {
      const img = getPieceImage(piece, color);
      if (img) {
  ...
  return Promise.all(promises).then(() => console.log('[Pieces] All pieces preloaded'));
}
